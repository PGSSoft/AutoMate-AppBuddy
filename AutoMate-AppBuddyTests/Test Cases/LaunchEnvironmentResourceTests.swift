...
class LaunchEnvironmentResourceTests: XCTestCase {
    ...
    func testParsingLaunchEnvironmentValueToResourceInExternalBundle() {
        ...
        XCTAssertEqual(resource.bundle, Bundle(identifier: "com.pgs-soft.AutoMate-AppBuddyTests"), "Bundle has unexpected identifier, \(resource.bundle.bundleIdentifier) instead of com.pgs-soft.AutoMate-AppBuddyTests")
    }
